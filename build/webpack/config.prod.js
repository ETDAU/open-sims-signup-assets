...
config.output.filename = 'open-sims-request-account.ui.' + project.version + '.js';
...
config.plugins = config.plugins.concat([
  ...
  new ExtractTextPlugin('open-sims-request-account.ui.' + project.version + '.css', {
    allChunks: true
  }),

  // Separate the vender in a different file.
  new webpack.optimize.CommonsChunkPlugin('vendors', 'open-sims-request-account.ui.vendors.' + project.version + '.js'),
